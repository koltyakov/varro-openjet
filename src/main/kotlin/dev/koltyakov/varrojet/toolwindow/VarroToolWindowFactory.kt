package dev.koltyakov.varrojet.toolwindow
...
import dev.koltyakov.varrojet.host.WebviewHost
...
class VarroToolWindowFactory : ToolWindowFactory, DumbAware {
    ...
    private fun buildPanel(
        ...
        if (!dev.koltyakov.varrojet.host.JcefSupport.isAvailable()) return unsupportedPanel()
        if (!dev.koltyakov.varrojet.host.WebviewAssets.isBundlePresent()) return missingBundlePanel()
