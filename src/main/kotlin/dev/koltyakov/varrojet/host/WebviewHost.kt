        ...
        jsQuery.addHandler { raw ->
            if (!disposed.get()) {
                ...
                if (envelope == null) {
                    ...
                    // Dispatch on a pooled thread: handlers do REST calls and file
                    // IO, and this callback runs on a CEF IO thread that must not
                    // block. Ordering per message type is preserved by the
                    // individual services, not by this channel.
